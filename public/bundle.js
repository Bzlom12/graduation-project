...
function calc() {
  ...
  var calcTotal = function calcTotal(a, b, c, d) {
    var reg = /IWANTPOPART/i;
    total = a + b + c;
...
function pictures() {
  ...
  var _loop = function _loop(i) {
    block[i].addEventListener('mouseover', function () {
      image[i].src = "img/sizes-".concat(i + 1, "-1.png");
    ...
    block[i].addEventListener('mouseout', function () {
      image[i].src = "img/sizes-".concat(i + 1, ".png");
...
function mainSlide() {
  ...
  function sliderWantAlso(n) {
    ...
    slidesWantAlso.forEach(function (item) {
      return item.style.display = 'none';
    });
